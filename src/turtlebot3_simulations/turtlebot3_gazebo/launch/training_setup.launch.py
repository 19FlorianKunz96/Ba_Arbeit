...
def generate_launch_description():
    ...
    node3= Node(package = 'turtlebot3_dqn',executable='dqn_agent',name='Agent',output = 'screen',parameters=[{'stagex':stage,'max_episodes':max_episodes,'stage_boost':stage_boost}],)
